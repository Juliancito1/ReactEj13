    ...
    try {
      if (pais !== "" && ciudad !== "") {
        const respuesta = await fetch(
          `https://api.openweathermap.org/data/2.5/weather?&lang=es&q=${ciudad},${pais}&units=metric&appid=0f0a5e1bc31c0328bec625ffcadc1bd3`
        );
        ...
        if (dato.cod !== "404") {
          ...
          alert("El pais o ciudad ingresado no existe");
        }
      }
    } catch (error) {}
  };
